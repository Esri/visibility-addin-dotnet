...
define([
  ...
  /* jshint ignore:start */
  // have to ignore parts of the regexp being too long
  // as they cannot be split over mulitple lines
  var strs = [
  {
  name: "DD",
  pattern: new RegExp([
  ...
  getFormattedGEOREFStr: function (fromValue, withFormatStr) {
    ...
    r.quadrant15lat = 
      fromValue[0].replace(r.lon + r.lat + r.quadrant15lon, "").match(/[a-zA-Z]{1}/)[0].trim();
