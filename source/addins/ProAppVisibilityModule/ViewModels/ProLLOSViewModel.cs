...
namespace ProAppVisibilityModule.ViewModels
{
    public class ProLLOSViewModel : ProLOSBaseViewModel
    {
        ...
        private string _ObserversLayerName = ProAppVisibilityModule.Properties.Resources.LLOSObserversLayerName;
        public string ObserversLayerName
        {
            get
            {
                ...
                {
                    _ObserversLayerName = string.Format("{0}_{1}", ProAppVisibilityModule.Properties.Resources.LLOSObserversLayerName, executionCounter);
                }
        ...
        private string _TargetsLayerName = ProAppVisibilityModule.Properties.Resources.LLOSTargetsLayerName;
        public string TargetsLayerName
        {
            get
            {
                if (executionCounter > 0)
                {
                    _TargetsLayerName = string.Format("{0}_{1}", ProAppVisibilityModule.Properties.Resources.LLOSTargetsLayerName, executionCounter);
                }
        ...
        private string _OutputLayerName = ProAppVisibilityModule.Properties.Resources.LLOSOutputLayerName;
        public string OutputLayerName
        {
            get
            {
                if (executionCounter > 0)
                {
                    _OutputLayerName = string.Format("{0}_{1}", ProAppVisibilityModule.Properties.Resources.LLOSOutputLayerName, executionCounter);
                }
        ...
        private string _SightLinesLayerName = ProAppVisibilityModule.Properties.Resources.LLOSSightLinesLayerName;
        public string SightLinesLayerName
        {
            get
            {
                if (executionCounter > 0)
                {
                    _SightLinesLayerName = string.Format("{0}_{1}", ProAppVisibilityModule.Properties.Resources.LLOSSightLinesLayerName, executionCounter);
                }
        ...
        private string _FeatureDatasetName = ProAppVisibilityModule.Properties.Resources.LLOSFeatureDatasetName;
        public string FeatureDatasetName
        {
            get
            {
                if (executionCounter > 0)
                {
                    _FeatureDatasetName = string.Format("{0}_{1}", ProAppVisibilityModule.Properties.Resources.LLOSFeatureDatasetName, executionCounter);
                }
        ...
        internal override async Task CreateMapElement()
        {
            try
            {
                ...
                {
                    ArcGIS.Desktop.Framework.Dialogs.MessageBox.Show(ProAppVisibilityModule.Properties.Resources.MsgSurfaceLayerNotFound,
                    ...
                    && LLOS_TargetsInExtent.Any() || TargetAddInPoints.Any())
                {
                    ...
                    if (!success)
                        MessageBox.Show(Properties.Resources.LLOSViewError,
                            ProAppVisibilityModule.Properties.Resources.CaptionError);
                }
                else
                {
            ...
            try
            {
                ...
                await ArcGIS.Desktop.Framework.Threading.Tasks.QueuedTask.Run(() =>
                {
                    using (Geodatabase geodatabase = new Geodatabase(new FileGeodatabaseConnectionPath(new Uri(CoreModule.CurrentProject.DefaultGeodatabasePath))))
                    {
                        ...
                        var enterpriseDefinitionNames = geodatabase.GetDefinitions<FeatureDatasetDefinition>().Where(i => i.GetName().StartsWith(ProAppVisibilityModule.Properties.Resources.LLOSFeatureDatasetName)).Select(i => i.GetName()).ToList();
                        ...
                        var targetLyrSuffix = GetLayerSuffix(ProAppVisibilityModule.Properties.Resources.LLOSTargetsLayerName, geodatabase);
                        var sightLinesLyrSuffix = GetLayerSuffix(ProAppVisibilityModule.Properties.Resources.LLOSSightLinesLayerName, geodatabase);
                        var outputLyrSuffix = GetLayerSuffix(ProAppVisibilityModule.Properties.Resources.LLOSOutputLayerName, geodatabase);
                ...
                await FeatureClassHelper.AddFieldToLayer(ObserversLayerName, ProAppVisibilityModule.Properties.Resources.TarIsVisFieldName, "SHORT");
                ...
                await FeatureClassHelper.AddFieldToLayer(TargetsLayerName, ProAppVisibilityModule.Properties.Resources.OffsetFieldName, "DOUBLE");
                await FeatureClassHelper.AddFieldToLayer(TargetsLayerName, ProAppVisibilityModule.Properties.Resources.OffsetWithZFieldName, "DOUBLE");
                await FeatureClassHelper.AddFieldToLayer(TargetsLayerName, ProAppVisibilityModule.Properties.Resources.NumOfObserversFieldName, "SHORT");
                ...
                success = await FeatureClassHelper.AddSurfaceInformation(TargetsLayerName, SelectedSurfaceName, ProAppVisibilityModule.Properties.Resources.ZFieldName);
                if (!success)
                    return false;

                await FeatureClassHelper.UpdateShapeWithZ(ObserversLayerName, ProAppVisibilityModule.Properties.Resources.ZFieldName, GetAsMapZUnits(surfaceSR, ObserverOffset.Value));
                await FeatureClassHelper.UpdateShapeWithZ(TargetsLayerName, ProAppVisibilityModule.Properties.Resources.ZFieldName, GetAsMapZUnits(surfaceSR, TargetOffset.Value));
                ...
                success = await FeatureClassHelper.CreateSightLines(ObserversLayerName,
                    ...
                    ProAppVisibilityModule.Properties.Resources.OffsetWithZFieldName,
                    ProAppVisibilityModule.Properties.Resources.OffsetWithZFieldName);
                ...
                await FeatureClassHelper.CreatingFeatures(ObserversLayerName, observerOutOfExtent, GetAsMapZUnits(surfaceSR, TargetOffset.Value), ProAppVisibilityModule.Properties.Resources.TarIsVisFieldName);
                ...
                await FeatureClassHelper.CreatingFeatures(TargetsLayerName, targetOutOfExtent, GetAsMapZUnits(surfaceSR, TargetOffset.Value), ProAppVisibilityModule.Properties.Resources.NumOfObserversFieldName);
                ...
                if (observersLayer != null && targetsLayer != null && sightLinesLayer != null && outputLayer != null)
                {
                    ...
                    await FeatureClassHelper.CreateVisCodeRenderer(GetLayerFromMapByName(SightLinesLayerName) as FeatureLayer,
                                                                   ProAppVisibilityModule.Properties.Resources.TarIsVisFieldName,
                                                                   1,
                                                                   0,
                    ...
                    await FeatureClassHelper.CreateVisCodeRenderer(GetLayerFromMapByName(OutputLayerName) as FeatureLayer,
                                                                   ProAppVisibilityModule.Properties.Resources.VisCodeFieldName,
                                                                   1,
                                                                   2,
                ...
                if (observerIDCollection.Any() || targetIDCollection.Any())
                {
                    if ((observerIDCollection.Count + targetIDCollection.Count) <= 10)
                    {
                        ...
                        if (targetIDCollection.Any())
                        {
                            if (msgString != "")
                                msgString = msgString + "\n";
                            msgString = msgString + Properties.Resources.LLOSViewObs1 + targetString;
                        }
